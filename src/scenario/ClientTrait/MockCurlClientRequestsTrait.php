...
namespace TestLibrary\Scenario\ClientTrait;
...
trait MockCurlClientRequestsTrait
{
    ...
    protected static function clearMockedClientRequests(): void
    {
    ...
    public static function mockPatchCustomerError(int $customerId): void
    {
        ClientTest::$mockedData[] = [
            'method' => Request::METHOD_PATCH,
            'url' => "http://memberzoneweb.docker/en/api/customer/{$customerId}",
    ...
    public static function mockGetSegment(int $domainId, int $segmentId): void
    {
        $segment = json_decode(self::$segment, true);
        $segment['id'] = $segmentId;
        $segment['domainId'] = $domainId;

        ClientTest::$mockedData[] = [
            'method' => Request::METHOD_GET,
            'url' => "http://segmentweb.docker/api/domain/{$domainId}/segment/{$segmentId}",
            'code' => Response::HTTP_OK,
